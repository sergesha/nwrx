...
describe('IntercomService', () => {
    ...
    it('should get content equal to afterward pushed value', inject([IntercomService], (service: IntercomService) => {
    ...
    it('should remove content and get \'null\' value', inject([IntercomService], (service: IntercomService) => {
    ...
    it('should get current (last) value', inject([IntercomService], (service: IntercomService) => {
